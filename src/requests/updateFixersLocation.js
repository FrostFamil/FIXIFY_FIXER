...
const updateFixersLoc = (postId, fixerId, latitude, longitude) => {
    return axios({
    method: 'put',
    url: 'http://192.168.0.88:8080/fixersLocation/updateFixersLoc',
    data: {
        postId: postId,
        fixerId: fixerId,
        latitude: latitude,
...
const addFixersLoc = (latitude, longitude, fixerId) => {
    return axios({
    method: 'put',
    url: 'http://192.168.0.88:8080/fixersLocation/addFixersLoc',
    data: {
        latitude: latitude,
        longitude: longitude,
        fixerId: fixerId
...
const getFixersPreviousLoc = (fixerId) => {
    return axios({
    method: 'post',
    url: 'http://192.168.0.88:8080/fixersLocation/getFixersPreviousLoc',
    data: {
        fixerId: fixerId
    }
    })
